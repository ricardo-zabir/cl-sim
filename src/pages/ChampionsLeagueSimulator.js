...
export default function ChampionsLeagueSimulator() {
  ...
  const bracket = useMemo(
    () => montarChaveamentoChampionsLeague(quartasTies, koPlacares),
    [quartasTies, koPlacares]
  );
  ...
  return (
    <div className="app-root theme-champions-league">
      <header className="app-header">
        ...
        <h1 className="app-title">Simulador Champions League</h1>
        <p className="app-subtitle">
          Simule a Champions League 2025/2026 a partir das quartas de finais e determine quem levará a taça.
        </p>
      </header>
        ...
        <div className="bracket">
          <section className="bracket__round">
            ...
            <div className="bracket__matches bracket__matches--ties">
              {bracket.qf.map((m) => renderConfrontoDuplo(m, { disabled: false }))}
            </div>
          </section>
